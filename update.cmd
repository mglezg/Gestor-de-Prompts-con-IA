@echo off
title Prompt Manager - Update

echo.
echo  ==========================================
echo   PROMPT MANAGER - UPDATE
echo  ==========================================
echo.
...
:: ── 2. Eliminar entorno existente (siempre) ───────────────
echo.
if exist ".venv" (
    echo  [2/5] Eliminando entorno virtual existente...
    rmdir /s /q ".venv"
    if errorlevel 1 (
        echo  ERROR: No se pudo eliminar .venv.
        echo  Asegurate de que ningun proceso lo esta usando y vuelve a intentarlo.
        pause
        exit /b 1
    )
    echo  [OK] Entorno anterior eliminado
) else (
    echo  [2/5] No habia entorno previo, continuando...
)
